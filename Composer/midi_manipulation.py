# This file is copied from Daniel Johnson's midi manipulation code in
#https://github.com/hexahedria/biaxial-rnn-music-composition/blob/master/midi_to_statematrix.py
